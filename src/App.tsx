...
function App() {
  ...
  return (
    <>
      <div className='main-container flex flex-col items-center text-white'>
        <section className='flex flex-col items-center bg-zinc-900'>
          <Header />
          <div className='w-[30vw] mt-[27vh] mb-[293px]'>
            <h1 className={`font-monospace hithere text-[7rem] mb-4 transition-all duration-1000 ${isTextEvent ? 'translate-y-0' : 'motion-reduce:translate-y-0 translate-y-20'}`} data-value="Hi there," ref={nameRef}>Hi there,</h1>
        ...
        <section className='bg-zinc-900'>
          <div className='w-full relative'>
            ...
            <div className='flex flex-col items-center pt-52 pb-64 isolate'>
              ...
              <div className='w-[70vw] grid grid-cols-3 gap-8 mt-40'>
                <div className='flex flex-col gap-4 border-r-2 border-gray-300 pr-4 motion-reduce:animation-none fade-in'>
                  ...
                  <p className='text-lg text-gray-200'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum expedita provident saepe, suscipit eos iste corrupti, reiciendis reprehenderit rerum illo hic quo ratione, cum eligendi asperiores fugiat animi repudiandae at?</p>
                </div>
                <div className='flex flex-col gap-4 text-center motion-reduce:animation-none fade-in'>
