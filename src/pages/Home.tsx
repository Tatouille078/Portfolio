            ...
            <div className='flex flex-col items-center text-gray-100 bg-gradient-to-tr from-zinc-900 via-zinc-950 via-25% to-zinc-800'>
                <section className='flex flex-col items-center overflow-hidden'>
                    ...
                    <div className='mt-[27vh] md:mb-[31vh] mb-[25vh] flex flex-col items-center group'>
                        ...
                        <h6 className={`lg:text-3xl md:text-2xl text-xl w-[90%] text-gray-300 text-center flex-wrap transition-all duration-1000 ${isTextEvent ? 'opacity-100 translate-y-0' : 'opacity-0 motion-reduce:opacity-100 motion-reduce:translate-y-0 translate-y-40'}`}>Je m'appelle, <br /> Je suis un developpeur web et jeux vidéo.</h6>
                    </div>
                    ...
                    <section className='flex flex-col justify-center items-center'>
                        <div className='lg:w-[75vw] w-full grid lg:grid-cols-2 mb-20 gap-28 lg:gap-0 pt-20 lg:pt-0'>
                            <div className="lg:mr-14 flex flex-col transition-all duration-1000">
                                <h2 className="self-center lg:text-[60px] xl:text-[68px] text-[54px] mb-8 motion-reduce:animate-none motion-reduce:opacity-100 fade-left">Qui suis-je?</h2>
                            ...
                            <div className="lg:ml-14 flex flex-col transition-all duration-1000">
                                <h2 className="lg:text-[60px] xl:text-[68px] text-[54px] text-gray-900 mx-auto self-center outline-4 outline rounded-2xl bg-gray-300 mb-8 px-8 motion-reduce:animation-none fade-right outline-gray-600">Développeur</h2>
