        ...
        <>
            <div className='flex flex-col items-center text-gray-100 bg-gradient-to-tr from-zinc-900 via-zinc-950 via-25%% to-zinc-800'>
                <section className='flex flex-col items-center'>
                    ...
                    <Header />
                    <div className='mt-[27vh] mb-[31vh] flex flex-col items-center group'>
                        <h1 className={`font-monospace mb-8 transition-all duration-1000 xl:text-[6.5rem] lg:text-7xl md:text-5xl mix-blend-difference ${isTextEvent ? 'translate-y-0' : 'motion-reduce:translate-y-0 translate-y-20'}`} data-value="Hi there!" ref={nameRef}>Hi there!</h1>
                        <h6 className={`text-3xl text-gray-300 text-center flex-wrap transition-all duration-1000 ${isTextEvent ? 'opacity-100 translate-y-0' : 'opacity-0 motion-reduce:opacity-100 motion-reduce:translate-y-0 translate-y-40'}`}>My name is Loïck Devismes, <br /> I'm a web and game developper.</h6>
                    </div>
                    ...
                    <div className='grid grid-cols-[3fr_2fr] w-[80vw] h-[72vh]'>
                        <div className='flex items-start flex-col pr-4'>
                            ...
                            <Link to='/project/SkyFlippy' className='relative flex py-2 mt-8 text-xl group'>
                                ...
                                <span className='absolute transitionContact3 w-[1000px] inset-0 h-full duration-[400ms] group-hover:w-[1200px]' />
                            </Link>
                        </div>
