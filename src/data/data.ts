...
const projects: Project[] = [
    {
        ...
        images: ['../assets/project/SkyFlippy.png', '../assets/project/SkyFlippy2.png'],
        titleColor: "#634960",
        descColor: "#403244",
    ...
    },
    {
        ...
        images: ["../assets/project/portfolio1.png", "../assets/project/portfolio2.png"],
        titleColor: "#BA9F76",
        descColor: "#A08252",
        subTitle1: "Technology used",
        subText1: "HTML, CSS avec Tailwind et Typescript avec React",
    ...
    },
    {
        ...
        images: ["../assets/project/wynnpack1.png", "../assets/project/wynnpack2.png"],
        titleColor: "#475060",
        descColor: "#313342",
        subTitle1: "Technology used",
    ...
    },
    {
        ...
        images: ["../assets/project/mario1.png", "../assets/project/mario2.png"],
        titleColor: "#495E45",
        descColor: "#313F2F",
        subTitle1: "Technology used",
    ...
    },
    {
        ...
        images: ["../assets/project/ap11.png", "../assets/project/ap12.png"],
        titleColor: "#098CBE",
        descColor: "#0C2842",
        subTitle1: "Technology used",
    ...
    },
    {
        ...
        images: ["../assets/project/meal1.png", "../assets/project/meal2.png"],
        titleColor: "#BAD9FF",
        descColor: "#5BA7FF",
        subTitle1: "Technology used",
    ...
    },
    {
        ...
        images: ["../assets/project/pokedex1.png", "../assets/project/pokedex2.png"],
        titleColor: "#E41A01",
        descColor: "#8F8F8F",
        subTitle1: "Technology used",
        subText1: "HTML, Tailwind CSS, Vanilla Javascript",
